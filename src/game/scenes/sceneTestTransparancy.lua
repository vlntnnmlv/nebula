...
root.setColor(Color(1.0, 1.0, 1.0, 0.0))

local node = Node.new(scene, root, SCREEN_WIDTH / 2, 0, SCREEN_WIDTH / 4, SCREEN_HEIGHT)
node.setColor(Color(0.0, 1.0, 0.0, 0.0))

local nody = Node.image(scene, node, SCREEN_WIDTH / 2 - 100, 150, 200, 200, "planet.png")
nody.setShader("shine")
nody.setColor(Color(1.0, 0.0, 0.0, 0.0))